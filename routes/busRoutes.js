...
const {createBusOrder , getBusOrderById , getAllBusOrders , updateProgressStage , addProgressLog , uploadBusMedia , deleteBusOrder , generateAndSaveBusPdf , downloadBusPdf} = require('../controllers/busController');
...
router.get('/download-pdf/:id', auth, downloadBusPdf);
